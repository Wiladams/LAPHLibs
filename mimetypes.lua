...
References:
 ...
 The original data was in a human readable form.  This file
 is created using Lua as the data structure, so it can automatically
 be loaded as a table within Lua.

 {"<mime type>",""<subtype>" [,extensions]}
============================================ ==========
--]]
local mimetypes = {
